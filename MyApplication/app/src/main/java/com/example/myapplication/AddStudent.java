...
public class AddStudent extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button text = findViewById(R.id.add);
        ...
        text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextView A = findViewById(R.id.aubnet);
                String aubnet = A.getText().toString();

                if (rfid.equals("") || aubnet.equals("")){
                    //toast
                    Toast.makeText(AddStudent.this, "something is missing", Toast.LENGTH_SHORT).show();
                }
                else{
                    addStud s = new addStud();
                    s.aubnet = aubnet;
                    s.courseid  =courseid;
                    s.rfid = rfid;
                    s.execute();
...
class addStud extends AsyncTask<Void, Integer, String> {
    public String rfid;
    public String courseid;
    public String aubnet;

    private static String attend(String rfid, String courseid, String aubnet) throws Exception {

        String url = "https://nfcattend.azurewebsites.net/api/v1/Students?code=b2ESAb33XhAqp9wabNKK2REGG/FPa9yIaZi23DHru0L4kjBB5KasWA==";
        URL obj = new URL(url);
        ...
        String urlParameters = "rfid=" + rfid + "&courseid=" + courseid + "&aubNet=" + aubnet + "&ian=1";
    ...
    protected String doInBackground(Void... urls) {
        String result = "";
        try {
            result = attend(rfid, courseid, aubnet);
